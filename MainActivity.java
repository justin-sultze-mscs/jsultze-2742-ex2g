...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadSensorReadings() {
        ...
        this.httpClient.get(MainActivity.this, url, new AsyncHttpResponseHandler(){
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] reponseBody){
                String json = new String(reponseBody);
            ...
            @Override
            public void onFailure(int statusCode, Header[] headers, byte[] reponseBody, Throwable error){
